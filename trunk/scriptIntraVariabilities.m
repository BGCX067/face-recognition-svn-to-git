%session = {'Labelings/Labeling2-Facedetect_CORRECT_session1.txt','Labelings/Labeling2-Facedetect_CORRECT_session2.txt','Labelings/Labeling2-Facedetect_CORRECT_session3.txt'};
session = {'FDLabeled-s1.txt','FDLabeled-s2.txt','FDLabeled-s3.txt'};
